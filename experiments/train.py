...
# forward one sample
def train(input_variables, cap_target_variables, stop_target_variables, encoder, sent_decoder,
            ...
            if dataset_index % print_every == 0:
                ...
                print('[Iter: %d, Batch: %d]%s (%d %d%%) loss = %.3f stop_loss = %.3f, '
                    ...
                    (iter, batch_index, time_since(start, dataset_index / dataset_size), dataset_index,
                     dataset_index / dataset_size * 100,print_loss_avg,  print_stop_loss_avg,
                     print_caption_loss_avg, bleu_scores[0], bleu_scores[1], bleu_scores[2], bleu_scores[3]))
