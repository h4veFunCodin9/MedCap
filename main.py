...
parser.add_argument('--trainval-cap', required=False,
                    default="/Users/luzhoutao/courses/毕业论文/IU Chest X-Ray/dataset/BRATS/train_captions_seg.txt",
...
parser.add_argument('--test-cap', required=False,
                    default="/Users/luzhoutao/courses/毕业论文/IU Chest X-Ray/dataset/BRATS/test_captions_seg.txt",
...
lang.word2count = data_utils.generate_lang(train_dataset).word2count
lang.assign_weight()
